                    ...
                    <p>
                        ...
                        {this.props.prefLang === "fr-fr" ? (
                            ...
                            this.state.Department.NameEn
                                ...
                                <p>
                                    <h4>{this.strings.NumberOpportunities}</h4>
                        {this.state.Nmb_opt}
                    </p>
                                <p>
