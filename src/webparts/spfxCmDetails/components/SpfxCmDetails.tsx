            ...
            <>
                ...
                <div>
                    <p className={styles.desc_bold}>
                        ...
                        {this.props.prefLang === "fr-fr" ? (
                            <PrimaryButton 
                                text={this.state.Expired ? strings.ApplicationsClosed : strings.Apply} 
                        ...
                        {this.props.context.pageContext.user.email === this.state.ContactEmail ? (
                            <PrimaryButton 
                                ...
                                className={styles.margin_edit_buttom} text={strings.Delete} 
                        ...
                        >
                            <div className={`${styles.deleteModal}`}>
                                ...
                                <p 
                                    dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(strings.dialogText)}} 
